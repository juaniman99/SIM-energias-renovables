		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(comboBox.getSelectedItem().equals("Eolica"))
					lblDescripcion.setText("<html><p>Una buena opci�n. Genera electricidad aprovechando el movimiento del aire. Que giren esas aspas!</p></html>");
				if(comboBox.getSelectedItem().equals("Solar"))
					lblDescripcion.setText("<html><p>No cabe duda que el sol no sirve solo para broncearse. Quiz�s no sea la central m�s productiva, pero aprovecha el sol para producir unos cuantos KW a un buen precio.</p></html>");
			}
		});
