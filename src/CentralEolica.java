...
public class CentralEolica extends Central{
	...
	CentralEolica(int id, String nombre, int posX, int posY, float produccionMaxima) {
		super(id, nombre, posX, posY, produccionMaxima, new ImageIcon(new ImageIcon("megamanes.gif").getImage().getScaledInstance(70, 70, Image.SCALE_DEFAULT)), new ImageIcon(new ImageIcon("images/molino_off.png").getImage().getScaledInstance(70, 70, Image.SCALE_DEFAULT)));
